...
public class FKCAC {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        networkChannel.registerMessage(FKCACProtocolHandler.AuthHelloHandler.class,       ClientAuthHelloPacket.class,    11, Side.SERVER);
        networkChannel.registerMessage(FKCACProtocolHandler.AuthChallengeHandler.class,   ServerAuthChallengePacket.class,12, Side.CLIENT);
        networkChannel.registerMessage(FKCACProtocolHandler.AuthResponseHandler.class,    ClientAuthResponsePacket.class, 13, Side.SERVER);
        networkChannel.registerMessage(FKCACProtocolHandler.AuthResultHandler.class,      ServerAuthResultPacket.class,   14, Side.CLIENT);
        networkChannel.registerMessage(FKCACProtocolHandler.SecurityProfileHandler.class, CPacketSecurityProfile.class,   15, Side.SERVER);
